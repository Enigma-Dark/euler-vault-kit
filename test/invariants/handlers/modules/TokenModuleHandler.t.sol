...
contract TokenModuleHandler is BaseHandler {
    ...
    function approveTo(uint256 i, uint8 j, uint256 amount) external setup {
        bool success;
    ...
    function transferTo(uint256 i, uint8 j, uint256 amount) external setup {
        bool success;
        bytes memory returnData;
    ...
    function transferFromTo(uint256 i, uint8 j, uint256 u, uint256 amount) external setup {
        bool success;
        bytes memory returnData;
